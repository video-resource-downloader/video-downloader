    ...
    <div class="rounded p-5">
      ...
      <div class="flex w-full text-sm justify-between pt-8 text-slate-400">
        ...
        <div class="flex">
          ...
          <button class="pl-4" @click="toWebsite('https://github.com/video-resource-downloader/VideoDownloader')">{{ t('footer.source_code') }}</button>
          <button class="pl-4" @click="toWebsite('https://github.com/video-resource-downloader/VideoDownloader/issues')">{{ t('footer.help') }}</button>
          <button class="pl-4" @click="toWebsite('https://github.com/video-resource-downloader/VideoDownloader/releases')">{{ t('footer.update_log') }}</button>
        </div>
      </div>
    </div>
  </NModal>
